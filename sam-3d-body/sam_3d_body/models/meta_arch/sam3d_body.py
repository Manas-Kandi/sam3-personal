...
class SAM3DBody(BaseModel):
    ...
    def get_ray_condition(self, batch):
        ...
        meshgrid_xy = (
            ...
            .repeat(B, N, 1, 1, 1)
            .to(batch["img"].device)  # Use the device of the input batch
        )  # B x N x H x W x 2
        meshgrid_xy = (
    ...
    def run_inference(
        ...
        batch_lhand = recursive_to(batch_lhand, pose_output["mhr"]["joints_3d"].device)
        ...
        batch_rhand = recursive_to(batch_rhand, pose_output["mhr"]["joints_3d"].device)
